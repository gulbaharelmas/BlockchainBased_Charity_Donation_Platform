...
async function getTs() {
    const res = await fetch("https://api-sepolia.etherscan.io/api?module=account&action=txlist&address=0xCf5739410C28376BB698B911b2E654c00516cBbf&startblock=0&endblock=99999999&page=1&offset=10&sort=desc&apikey=PU18UGWNA9JCU16JP29XKW6BBBV36RT9CK");
    return await res.json();
}

const ts = getTs();
ts.then(function printData(data) {
    const excludedWallet = "0xCf5739410C28376BB698B911b2E654c00516cBbf";
