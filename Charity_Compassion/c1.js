...
//const progressElementId = 'c1'; // ID of the progress bar element
//updateProgressFromBlockchain(targetDonation,'c1');
//updateProgressFromBlockchain(100, 'c1');

//const { updateProgressFromBlockchain } = require('./donation.js');

/*setInterval(function() {
    updateProgressFromBlockchain(1, 'c1');
  }, 6000);*/
...
const contractAddress = "0xCf5739410C28376BB698B911b2E654c00516cBbf";

//const sepoliaWallet1 = "0xCf5739410C28376BB698B911b2E654c00516cBbf";

//var donationcount=4;
var donationcount1 = parseInt(localStorage.getItem("donationcount1"))||10;
let provider;
let contract;
function updateDonationCount1(count) {
  donationcount1 = count;
  localStorage.setItem("donationcount1", count.toString());
}
...
export async function connectWalletAndDonate() {
    if (typeof window.ethereum !== "undefined") {
      try {
        ...
        const donationAmount = ethers.utils.parseEther("0.0000001"); // parseEther fonksiyonunu utils altından çağır
        ...
        //donationcount++;
        updateDonationCount1(donationcount1 + 1);
        console.log("bağiş sayisi:",donationcount1);
...
window.addEventListener("load", () => {
  ...
  const storedCount = localStorage.getItem("donationcount1");
  if (storedCount !== null) {
    donationcount1 = parseInt(storedCount);
  }
});
...
document.addEventListener("DOMContentLoaded", () => {
    document.getElementById("donateButton1").addEventListener("click", connectWalletAndDonate);
});

/* ******************************************************************progress bar *************************************************/

async function totalDonate(){
  var total=donationcount1*0.01;
