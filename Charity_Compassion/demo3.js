...
async function getTs() {
    const res = await fetch("https://api-sepolia.etherscan.io/api?module=account&action=txlist&address=0x416cacAa5F9D98Dd0321ba5Bd21a89d648Ae0c2b&startblock=0&endblock=99999999&page=1&offset=100&sort=desc&apikey=PU18UGWNA9JCU16JP29XKW6BBBV36RT9CK");
    return await res.json();
}

const ts = getTs();
ts.then(function printData(data) {
    const excludedWallet = "0x416cacAa5F9D98Dd0321ba5Bd21a89d648Ae0c2b";
